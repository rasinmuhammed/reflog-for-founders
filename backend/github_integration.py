    ...
    def analyze_user(self, username: str) -> dict:
        ...
        try:
            ...
            for repo in repos:
                ...
                is_active = last_push and last_push.replace(
                    tzinfo=None) > three_months_ago if last_push.tzinfo else last_push and last_push > three_months_ago
    ...
    def get_recent_activity(self, username: str, days: int = 7) -> dict:
        ...
        try:
            ...
            for event in events:
                ...
                created_at_naive = event.created_at.replace(
                    tzinfo=None) if event.created_at.tzinfo else event.created_at
